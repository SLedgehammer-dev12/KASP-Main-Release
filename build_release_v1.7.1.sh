#!/bin/bash
# KASP macOS Release Build Script v1.7.1
# Creates: dist/KASP v1.7.1.app
# V1.7.1: Premium UI theme and dynamic adjustable splitter.
...
echo "============================================"
echo "  KASP macOS Release Build — v1.7.1"
echo "============================================"
echo ""
