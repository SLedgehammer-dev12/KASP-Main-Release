#!/bin/bash
# KASP macOS Release Build Script v2.0.0
# Creates: dist/"KASP v2.0.0".app
# V2.0.0: DWSIM EOS entegrasyonu + gelişmiş kullanıcı yönetimi + 3-layer mimari
...
echo "============================================"
echo "  KASP macOS Release Build — v2.0.0"
