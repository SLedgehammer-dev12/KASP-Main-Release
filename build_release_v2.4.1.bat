@echo off
REM KASP Windows Release Build Script v2.4.1
REM Creates: dist\"KASP v2.4.1.exe"

cd /d "%~dp0"

echo ============================================
echo   KASP Windows Release Build — v2.4.1
echo   Smart Method Badge & Shootout Fixes
echo ============================================
echo.
