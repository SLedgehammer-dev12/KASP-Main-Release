#!/bin/bash
# KASP macOS Release Build Script v1.7.4
# Creates: dist/"KASP v1.7.4".app
# V1.7.4: DWSIM EOS entegrasyonu + gelişmiş kullanıcı yönetimi + 3-layer mimari
...
echo "============================================"
echo "  KASP macOS Release Build — v1.7.4"
