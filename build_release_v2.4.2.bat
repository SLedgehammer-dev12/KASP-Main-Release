@echo off
REM KASP Windows Release Build Script v2.4.2
REM Creates: dist\"KASP v2.4.2.exe"

cd /d "%~dp0"

echo ============================================
echo   KASP Windows Release Build — v2.4.2
echo   Offline Password Recovery & Security Updates
echo ============================================
echo.
